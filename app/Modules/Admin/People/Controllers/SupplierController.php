...
class SupplierController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        */
        ...
        if (!$search) {
            ...
            return Person::where('company_id', $request['company_id'])->where('is_' . $person, '1')->get();
        }
        ...
        $people = DB::table('people')
            ...
            ->where('people.company_id', $request['company_id'])->where('is_' . $person, '1');
...

    {
        ...
        if ($request->has('receipt_itemsPerPage')) {
            ...
            $receipts  =  Receipt::where('person_id', $request->id)->where('receipts.document_type_id', $type_id)->orderBy('id', 'DESC')->paginate($request->receipt_itemsPerPage != -1 ? $request->receipt_itemsPerPage : '', ['*'], 'receipt_page');
