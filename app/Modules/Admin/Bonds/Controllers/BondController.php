...
class BondController extends Controller
{
    ...
    public function index(Request $request, $id)
    {
        ...
        return [
            'bond' => $bond,
            'customers' => Person::where('company_id', $request['company_id'])->where('is_customer', '1')->get(),
    ...
    {
        $bond = Bond::select('bonds.*', 'people.company_name', 'accounts.account_code', 'accounts.ar_name')->where('bonds.company_id', $request['company_id'])->where('bonds.id', $id);
    ...
    public function all(Request $request)
    {
        ...
        $bonds = Bond::select('bonds.*', 'people.company_name', 'accounts.account_code', 'accounts.ar_name')->where('bonds.company_id', $request['company_id']);
