<template>
    <v-form ref="form" style="height: 100%">
        <div class="grey lighten-2 pt-16 px-4" style="height: 100%">
            <v-row style="height: 100%" class="justify-space-between">
                <v-col class="white rounded-lg ml-2" style="height: 100%">
                    <div>
                ...
                <v-col class="white mr-2 rounded-lg" style="height: 100%">
                    <v-row> <v-col>saksj sdsd </v-col> </v-row>
                    <v-divider
                        style="
                            margin-left: -12px;
                            margin-right: -12px;
