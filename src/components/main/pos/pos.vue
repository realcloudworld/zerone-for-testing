    ...
    <v-form ref="form" style="height: 100%">
        <div class="grey lighten-2 px-4" style="height: 100%">
            <v-row style="height: 100%" class="justify-space-between">
                ...
                <v-col
                    cols="8"
                    class="white mr-2 rounded-lg"
                    style="height: 100%"
                >
                    <v-row>
                        <v-col>
                            <v-layout column style="max-height: 75vh">
                                <v-flex style="overflow: auto">
                                    ...
                                    >
                                        ...
                                        <template v-slot:item.action="{ item }">
                                            <div style="display:none" v-html="quantity_in_minor_unit(item)"></div>
                                            <v-icon
                                                color="red"
                                                small
...
*/
    ...
    methods: {
        scrollTODown() {
            document.getElementById("scrl").scrollIntoView({block: "end"})
        },
        discountEmptyCheck() {
        ...
        */
        ...
        submit() {
            ...
            if (
                ...
                this.bill.paid_amount != this.bill.total_amount-this.bill.discount
            ) {
                this.snackbarText =
