                ...
                <v-row>
                  <v-col cols="12" lg="6">
                    ...
                    autofocus
                      ...
                      :rules="required.concat(is_exists)"
                      @input="is_exists = [true]"
                    ></v-text-field>
                  </v-col>
                  <v-col cols="12" lg="6">
                    <v-text-field
    ...
    >
      ...
      <template v-slot:item.actions="{ item }">
        <v-tooltip bottom>
          ...
          <span style="font-size: 10px">حذف المجموعة</span>
        </v-tooltip>
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
          ...
          <span style="font-size: 10px">تعديل المجموعة</span>
        </v-tooltip>
      </template>
    </v-data-table>
  </div>
...
export default {
  ...
  methods: {
    ...
    showDialog(item) {
      this.required = [(value) => !!value || "الحقل مطلوب."];
      this.isunique = [];
      this.is_exists = [];
