        ...
        <div>
            ...
            <v-card max-width="100%">
                    ...
                    <v-container>
                        ...
                        <v-row>
                            ...
                            >
                                ...
                                <template
                                    v-slot:item.product_unit_id="{ item }"
                                >
                                    <v-autocomplete
                                ...
                                <template
                                    v-slot:item.quantity_in_minor_unit="{
                                        item,
                                    }"
                                >
                                    <v-text-field
                                ...
                                <template
                                    v-slot:item.total_befor_tax="{ item }"
                                >
                                    <v-text-field
                                        disabled
                                        hide-no-data
                                        ...
                                        outlined
                                        :value="
                                            total_befor_tax(item).toFixed(2)
                                        "
                                    ></v-text-field>
                                </template>
                ...
                <v-card-actions>
                    ...
                    >
                        <v-icon class="white--text">mdi-plus-box</v-icon>احضار
                        المعلقات
                    </v-btn>
                </v-card-actions>
            </v-card>
