...
export default {
    ...
    storeAccountOpeningBalance(balance) {
        return Api.post("/accounts/account_opening_balance", balance);
    },
    ...
    deleteOpeningBalance(params) {
        return Api.delete("/accounts/opening_balance", { params: params });
    },
    getOpeningBalance(params) {
        return Api.get("/accounts/opening_balances", { params: params });
    },
};