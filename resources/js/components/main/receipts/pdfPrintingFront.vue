<template>
  <div class="page content ar">
            ...
            <div class="col-xs-12">
              ...
              >
                ...
                <tbody class="center-align-row">
                  ...
                  >
                    <td>
                      {{ receipt.receipt_bills.indexOf(receipt_bill) + 1 }}
                    </td>
                    ...
                    <td>{{ receipt_bill.amount }}</td>
                    <td>{{ receipt_bill.remaining_amount_at_all }}</td>
    ...
    <button @click="generateReport()">mmsl</button>
    <div class="receipt-header">
      <div class="company-info">
        <h4>{{ receipt.company_name }}</h4>
        <div>{{ receipt.company_address }}</div>
