      ...
      <v-card-text>
        ...
        <v-row>
          <v-data-table
            ...
            :items="stocktake.stocktake_details"
            class="elevation-1"
...
export default {
  ...
  methods: {
    ...
    deleteItem(item) {
      this.stocktake.stocktake_details.splice(
        this.stocktake.stocktake_details.indexOf(item),
        1
      );
    },
    ...
    showThisProduct(selected_product) {
      if (
        this.stocktake.stocktake_details.findIndex(
      ...
      this.stocktake.stocktake_details.unshift(selected_product);
      return;
    },
