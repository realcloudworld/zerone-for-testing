        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              ...
              @click="deleteOpening_balance(item)"
            >
...
export default {
  ...
  methods: {
    ...
    deleteOpening_balance(item) {
      ...
      Account.deleteOpeningBalance(item.id).then((response) => {
  ...
  created() {
    this.table_loading = true;
    Account.getOpeningBalance().then((response) => {
      this.table_loading = false;
      ...
      console.log(this.opening_balances);
    });
  },
};
</script>
