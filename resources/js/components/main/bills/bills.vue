  ...
  <div>
    ...
    >
      ...
      <template v-slot:item.actions="{ item }">
        ...
        <router-link :to="proper_route + '/print/' + item.id"
          ><v-icon small>mdi-printer</v-icon></router-link
        >
  ...
  methods: {
    ...
    createPage(route_to) {
      if (route_to.name == "purchases") {
        ...
        this.new_ret_bill = { title: "إضافة مرتجع مشتريات", link: "purchase_return" };
        this.document_type_id = 1;
        this.proper_route = "purchase";
        this.getBills();
        this.receipt.document_type_id = 5;
      ...
      if (route_to.name == "invoices") {
        ...
        this.new_ret_bill = { title: "إضافة مرتجع مبيعات", link: "invoice_return" };
