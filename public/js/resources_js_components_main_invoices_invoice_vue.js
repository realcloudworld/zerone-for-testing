            ...
            const __WEBPACK_DEFAULT_EXPORT__ = ({
                ...
                methods: {
                    ...
                    total_tax: function total_tax() {
                        this.invoice.total_tax = this.invoice.invoice_details.reduce(function(a, b) {
                            return +a + +b.sold_tax_value;
                        }, 0);
                        return this.invoice.total_tax;
                    },
                    total_amount: function total_amount() {
                        this.invoice.total_amount = this.total_without_products_tax() + this.total_tax() + this.invoice.additional_expenses;
                                                                                    ...
                                                                                    _vm._g(
                                                                                        _vm._b({
                                                                                                ...
                                                                                                model: {
                                                                                                    ...
                                                                                                    expression: "item.expires_at.split(' ')[0]"
                                                                                                }
                                                                                            },
                                                                                            "v-text-field",
                                                                                            _vm.attrs,
                                                                                            ...
                                                                                            "v-col", {
                                                                                                ...
                                                                                                _c("v-autocomplete", {
                                                                                                    ...
                                                                                                    model: {
                                                                                                        ...
                                                                                                        expression: "item.sold_discount_type_id"
                                                                                                    }
                                                                                                })
                                                                                            ],
                                                                                            1
