...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    ...
    return _ref = {
      ...
      reference: ""
    }, _defineProperty(_receipt, "person_id", ""), _defineProperty(_receipt, "account_id", ""), _defineProperty(_receipt, "document_type_id", ""), _defineProperty(_receipt, "payment_type_id", ""), _defineProperty(_receipt, "description", ""), _defineProperty(_receipt, "amount", ""), _receipt)), _ref;
  },
  methods: {
    ...
    createPage: function createPage(to, status) {
      ...
      _apis_Receipt__WEBPACK_IMPORTED_MODULE_1__.default.create({
        ...
        _this3.people = response.data.people.filter(function (elem) {
          return elem.name != "افتراضي";
        });
        _this3.from_accounts = response.data.accounts.accounts;
        _this3.receipt.reference = response.data.receipt.reference;
      });
    }
  },
  watch: {
